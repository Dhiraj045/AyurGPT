...
function App() {
  ...
  async function sendMessage(){
    ...
    try {
      ...
      const response = await axios.post("http://localhost:3000",{message:typeInput},{
        headers:{
...
    }
  ...
  return (
    <div className="App">
      ...
      <Paper elevation={0} style={{position:'fixed',bottom:0,padding:20,paddingLeft:0,width:'100%',marginTop:10,marginRight:10}}>
